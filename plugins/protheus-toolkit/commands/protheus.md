...
| migra, converte, moderniza, prw para tlpp, migrate | migrator | 3 |
| gera, cria, implementa, faz um, generate, scaffold | code-generator | 4 |
| o que e, como funciona, documentacao, funcao, tabela, docs, referencia | docs-reference | 5 |
| fluxo, processo, modulo, negocio, PE de, ponto de entrada, business | process-consultant | 6 |
...
- "migra e revisa o codigo" → migra tem prioridade 3, revisa tem 2 → code-reviewer

Se nenhum padrao casar ou se o prompt for muito generico:
Pergunte ao usuario: "O que voce precisa? (1) Gerar codigo (2) Revisar codigo (3) Debug (4) Migrar (5) Buscar referencia (6) Consultar processo de negocio"
